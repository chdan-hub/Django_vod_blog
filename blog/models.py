...
class Blog(TimestampModel):
    ...
    def save(self, *args, **kwargs):
        ...
        thumbnail_extenstion = image_path.suffix.lower()
        thumbnail_filename = f'{thumbnail_name}_thumb{thumbnail_extenstion}'

        if thumbnail_extenstion in ['.jpg', '.jpeg']:
            file_type = 'JPEG'
        elif thumbnail_extenstion == '.gif':
            file_type = 'GIF'
        elif thumbnail_extenstion == '.png':
            file_type = 'PNG'
        else:
            return super().save(*args, **kwargs)
